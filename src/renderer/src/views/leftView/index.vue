...
const firstIcons = [
  { id: 1, normal: '#icon-gongzuotai1', hover: '#icon-gongzuotai1-copy', title: '工作台', router: '/workbench' },
  { id: 2, normal: '#icon-jurassic_process', hover: '#icon-jurassic_process-copy', title: '工作流', router: '/workflow' },
  { id: 3, normal: '#icon-huanjingbianliang', hover: '#icon-huanjingbianliang-copy', title: '环境变量', router: '/envBench' },
  { id: 4, normal: '#icon-gongzuotai', hover: '#icon-gongzuotai-copy', title: '工具箱', router: '/workbox' },
];
