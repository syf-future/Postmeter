...
import { WorkFlow, WorkFlowSql } from '@renderer/interfaces/workFlow'
import { ref } from 'vue'
...
const workflowName = ref<string>(props.workFlowSql?.name || '')
...
<template>
  <div id="workflowStyle">
    <div class="workflowInfoStyle">
      ...
      <div class="row">
        <div class="item">
          <label class="field-label">查询次数</label>
          <div class="control">
